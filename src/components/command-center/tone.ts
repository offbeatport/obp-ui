...
type ToneClasses = { text: string; solid: string; soft: string };

export const TONE: Record<Tone, ToneClasses> = {
    green: { text: "text-success", solid: "bg-success", soft: "bg-success-soft" },
    blue: { text: "text-info", solid: "bg-info", soft: "bg-info-soft" },
    violet: { text: "text-approval", solid: "bg-approval", soft: "bg-approval-soft" },
    slate: { text: "text-neutral", solid: "bg-neutral", soft: "bg-neutral-soft" },
    amber: { text: "text-warning", solid: "bg-warning", soft: "bg-warning-soft" },
    red: { text: "text-destructive", solid: "bg-destructive", soft: "bg-destructive-soft" },
};
