...
// The company-page tab nav as an iOS-style "segmented pill" (tab-select variant 2):
// a white pill slides behind the active tab. Meant to float top-right over the
// full-bleed infinite canvas.

export type SegTab = { key: string; label: string; badge?: string | number };

export function CompanySegmentedTabs({
    tabs,
    active,
    onSelect,
}: {
