  ...
  return (
    <TooltipProvider>
      <div className="mx-auto max-w-5xl px-6 py-12">
        <header className="mb-10 flex items-start justify-between gap-6">
          <div>
            <div className="mb-2 text-xs font-semibold uppercase tracking-[0.14em] text-faint">
              cslopslop design system
            </div>
            <h1 className="font-display text-4xl font-light">The kitchen sink</h1>
            <p className="mt-2 max-w-xl font-serif text-[17px] italic text-muted-foreground">
              One style, one archetype. Every company cslopslop builds is stamped from these tokens
              and components — re-themed by brand, never re-invented.
            </p>
          </div>
          <ThemeToggle />
        </header>
        ...
        <Section title="Color" hint="Surfaces, brand & the status language">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <Swatch name="accent (soft)" className="bg-accent" fg="text-accent-foreground" />
              <Swatch name="ring" className="bg-ring" fg="text-primary-foreground" />
              <Swatch name="foreground" className="bg-foreground" fg="text-background" />
            </div>
          </div>
          <div>
        ...
        <Section title="Typography" hint="Inter · Space Grotesk · Spectral · JetBrains Mono">
          <div className="space-y-3">
            <p className="font-display text-4xl font-light tracking-tight">
              Display — Space Grotesk Light
            </p>
            <p className="font-sans text-lg">Sans — Inter, the working body typeface.</p>
            <p className="font-serif text-lg italic text-muted-foreground">
              Serif — Spectral italic, for editorial voice and theses.
            </p>
            <p className="font-mono text-sm text-muted-foreground">
              Mono — JetBrains Mono · $12,480 MRR · run 4a275959 · 7/10
            </p>
          </div>
        </Section>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <Card className="border-approval shadow-e2 ring-4 ring-approval-soft">
              <CardHeader>
                ...
                <CardDescription>Demo Co · run 4a275959 · doneWhen green</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2 rounded-lg border bg-secondary px-3 py-2 font-mono text-xs text-muted-foreground">
                ...
                <div className="flex items-center gap-2 rounded-lg border border-success/40 bg-success-soft px-3 py-2 text-xs">
                  <Check className="size-4 text-success" />
                  <span>
                    <b className="text-success">Green</b> — POST /signup → 200, record persisted
                  </span>
                </div>
              </CardContent>
        ...
        <Section title="Tabs" hint="Company lenses">
          <Tabs defaultValue="build" className="max-w-lg">
            ...
            <TabsContent value="build" className="pt-3 text-sm text-muted-foreground">
              The code actions — the walking skeleton, then capability + depth features.
            </TabsContent>
            <TabsContent value="distribute" className="pt-3 text-sm text-muted-foreground">
              SEO pages, build-in-public posts, cold outreach, channels.
            </TabsContent>
            <TabsContent value="monetize" className="pt-3 text-sm text-muted-foreground">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    A planning run will decompose it into the first code actions and seed the
                    company brain.
                  </DialogDescription>
                </DialogHeader>
                <DialogFooter>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="text-destructive">Kill</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <Tooltip>
              ...
              <TooltipContent>Reversible code actions auto-run on green</TooltipContent>
            </Tooltip>
          </div>
        </Section>
          ...
          <Table>
            ...
            <TableBody>
              {[
                ...
                ["Post the launch on X", "message", "Demo Co", "approval", "awaiting you"],
        ...
        <p className="mt-14 border-t pt-6 text-center text-xs text-faint">
          Edit tokens in <code className="font-mono">src/styles/globals.css</code> · rules in{" "}
