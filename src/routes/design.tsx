    ...
    return (
        <TooltipProvider>
            <div className="mx-auto max-w-5xl px-6 py-12">
                <header className="mb-10 flex items-start justify-between gap-6">
                    <div>
                        ...
                        <p className="mt-2 max-w-xl font-serif text-[17px] italic text-muted-foreground">
                            One style, one archetype. Every company cslopslop builds is stamped from
                            these tokens and components - re-themed by brand, never re-invented.
                        </p>
                    </div>
                    <ThemeToggle />
                </header>
                ...
                <Section
                    title="Typography"
                    hint="Inter · Space Grotesk · Spectral · JetBrains Mono"
                >
                    <div className="space-y-3">
                        ...
                        <p className="font-sans text-lg">
                            Sans - Inter, the working body typeface.
                        </p>
                ...
                <p className="mt-14 border-t pt-6 text-center text-xs text-faint">
                    ...
                    in <code className="font-mono">DESIGN.md</code>
                </p>
            </div>
        </TooltipProvider>
    );
